...
const string2 = "imseesea"; //작은따옴표 가능
const string3 = `뽀로로${string1} ${1 + 1} `; //백틱 가능
...
console.log(userB);
console.log(userB.parent.name); //leejunho
console.log(userB["parent"]["name"]); //leejunho

//배열에 객체 넣기
const users = [userA, userB];

console.log(users[0]); //{name:leejunho'}
console.log(users[0].name); //leejunho
console.log(users[0]["name"]); //leejunho
